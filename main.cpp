...
int main()
{
    ...
    //int number_of_persons;
    //cout<<"Enter number of people involved."<<endl;
    //cinn>number_of_persons;

    int graph[number_of_persons][number_of_persons] ;

    for (int i=0;i<number_of_persons;i++){
        for (int j=0;j<number_of_persons;j++){
            if (i==j){
                cout<<"Enter the amount person "<<i<<" owes to person "<<j<<" (Enter 0)"<<endl;
            }
            else{
                cout<<"Enter the amount person "<<i<<" owes to person "<<j<<endl;
            }
